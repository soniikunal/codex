...
const SciencePage: React.FC<{ carouselData: CarouselItem[] }> = ({
  carouselData,
}) => {
  ...
  return (
    <>
      <section
        id="slide1"
        className="slider-section inner-page-slider shapedividers_com-7550"
      >
        {/* <div className="slider-area exsciton-bg slider-bg-1 relative-position ">
        ...
        >
          {carouselData.map((item, idx) => (
            <div
              ...
              style={{
                backgroundImage: `linear-gradient(0deg, rgb(57 36 103 / 33%), rgba(0, 0, 0, 0.8)),
                url("${item.imageUrl}")`,
              }}
            >
