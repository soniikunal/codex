...
const CodingPage: React.FC<{ carouselData: CarouselItem[] }> = ({
  carouselData,
}) => {
  return (
    <>
      <section
        id=""
        className="slider-section inner-page-slider shapedividers_com-9470"
      >
        <OwlCarousel
          className=""
          loop
        ...
        >
          {carouselData.map((item, idx) => (
            <div
              ...
              style={{
                backgroundImage: `linear-gradient(0deg, rgb(4 50 90 / 55%), rgba(0, 0, 0, 0.8)), url("${item.imageUrl}")`,
              }}
            >
